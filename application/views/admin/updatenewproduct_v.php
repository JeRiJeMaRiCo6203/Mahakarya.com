     ...
     <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url("adm_newproduct/aksi_update");?>" method="post">
                    <?php
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="f2" class="form-control">
                            <option value="1"
                                    <?php if($target[0]->id_kategori =='1') echo "selected"; ?> >Accesories
                            </option>
                            <option value="2"
                                    <?php if($target[0]->id_kategori =='2') echo "selected"; ?> >Display
                            </option>
                            <option value="3"
                                    <?php if($target[0]->id_kategori =='3') echo "selected"; ?> >Furniture
                            </option>
                        </select>
                      </div>
                    </div>
