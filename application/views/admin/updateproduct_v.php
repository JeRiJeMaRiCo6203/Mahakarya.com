     ...
     <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url("adm_product/aksi_update");?>" method="post">
                    <?php
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="f2" class="form-control">
                              <option value="1"
                                      <?php if($target[0]->id_kategori =='1') echo "selected"; ?> >Unique Bags
                              </option>
                              <option value="2"
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="f8" class="form-control">
                              <option value="new"
                                      <?php if($target[0]->id_kategori =='1') echo "selected"; ?> >New
                              </option>
                              <option value="old"
                                      <?php if($target[0]->id_kategori =='2') echo "selected"; ?> >Old
                              </option>
                            </select>
                      </div>
                    </div>
