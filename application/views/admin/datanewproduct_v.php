<html>
   <head>
		<title>Data New Product</title>
   </head>
   <body>
     <div class="x_panel">
      <div class="x_title">
        <h2>Data Koleksi Teratas</h2>
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url("adm_newproduct/aksi_insert");?>" method="post">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <select name="f2" class="form-control">
                                  <option value="1">Kategori Teratas</option>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <select name="f8" class="form-control" disabled="disabled">
            ...
            <tbody>
          		<?php
          		 ...
          		 foreach($datanya->result() as $perdata){
                      ...
                      <td><a class='btn btn-success' href='".site_url('adm_newproduct/update/'.$perdata->id_produk)."'>Edit</a></td>
                      <td><a class='btn btn-danger' href='".site_url('adm_newproduct/aksi_delete/'.$perdata->id_produk)."'>Delete</a></td>
          					</tr>";
                       $i++;
          		 }
          		?>
