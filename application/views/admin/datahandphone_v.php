                     ...
                     <div class="modal-dialog modal-lg">
                       <div class="modal-content">
                         ...
                         <div class="modal-body">
                           <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url("adm_handphone/aksi_insert");?>" method="post">
            ...
            <tbody>
          		<?php
          		 ...
          		 foreach($datanya->result() as $perdata){
                      ...
                      <td>$perdata->harga</td>
          					  <td>$perdata->stok</td>
                      <td><a class='btn btn-success' href='".site_url('adm_handphone/update/'.$perdata->id_produk)."'>Edit</a></td>
                      <td><a class='btn btn-danger' href='".site_url('adm_handphone/aksi_delete/'.$perdata->id_produk)."'>Delete</a></td>
          					</tr>";
                       $i++;
          		 }
          		?>
