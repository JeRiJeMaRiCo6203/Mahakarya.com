     ...
     <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url("adm_featuredproduct/aksi_update");?>" method="post">
                    <?php
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="f2" class="form-control">
                            <option value="1"
                                    <?php if($target[0]->id_kategori =='1') echo "selected"; ?> >Figuratif
                            </option>
                            <option value="2"
                                    <?php if($target[0]->id_kategori =='2') echo "selected"; ?> >Abstrak
                            </option>
                            <option value="3"
                                    <?php if($target[0]->id_kategori =='3') echo "selected"; ?> >Non-Figuratif
                            </option>
                            <option value="4"
                                    <?php if($target[0]->id_kategori =='4') echo "selected"; ?> >Representasional
                            </option>
                            <option value="5"
                                    <?php if($target[0]->id_kategori =='5') echo "selected"; ?> >Relief
                            </option>
                            <option value="6"
                                    <?php if($target[0]->id_kategori =='6') echo "selected"; ?> >Performatif
                            </option>
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="number" min="0" name="f7" required="required" value="<?php echo $target[0]->harga_baru ?>" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="f8" class="form-control" >
                              <option value="old"
                                      <?php if($target[0]->id_kategori =='old') echo "selected"; ?> >Old
                              </option>
                              <option value="old"
                                      <?php if($target[0]->id_kategori =='new') echo "selected"; ?> >New
                              </option>
                            </select>
                      </div>
                    </div>
