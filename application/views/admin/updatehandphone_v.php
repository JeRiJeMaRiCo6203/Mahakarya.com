     ...
     <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url("adm_handphone/aksi_update");?>" method="post">
                    <?php
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="file" name="f3" value="<?php echo $target[0]->foto ?>" method="post" enctype="multipart/form-data" class="form-control col-md-7 col-xs-12" required>
                        </input>
                      </div>
                    </div>
                    <div class="form-group">
