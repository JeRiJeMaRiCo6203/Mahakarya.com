<?php
	...
	class adm_laptop extends CI_Controller{
        //properti
    public $table_sumber;
      ...
      $this->load->view('link/menu_admin');
			$data['datanya'] = $this->product_m->tableLaptop($this->table_sumber);
			$this->load->view('admin/datalaptop_v',$data);
		}
		...
		function aksi_insert(){
			...
			redirect('adm_laptop');
			 ...
			 public function update($id_produk){
				 ...
				 $this->load->view('admin/updatelaptop_v',$data);
				}
