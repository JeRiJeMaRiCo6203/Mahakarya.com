<?php
	...
	class adm_newproduct extends CI_Controller{
        //properti
    public $table_sumber;
      ...
      $this->load->view('link/menu_admin');
			$data['datanya'] = $this->product_m->tableNewProductData($this->table_sumber);
			$this->load->view('admin/datanewproduct_v',$data);
		}
    ...
    function aksi_insert(){
      ...
      redirect('adm_newproduct');
       ...
       public function update($id_produk){
         ...
         $this->load->view('admin/updatenewproduct_v',$data);
        }
