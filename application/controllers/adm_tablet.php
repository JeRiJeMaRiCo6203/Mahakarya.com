<?php
	...
	class adm_tablet extends CI_Controller{
        //properti
    public $table_sumber;
      ...
      $this->load->view('link/menu_admin');
			$data['datanya'] = $this->product_m->listPatung($this->table_sumber);
			$this->load->view('admin/datatablet_v',$data);
		}
		...
		function aksi_insert(){
			...
			redirect('adm_tablet');
			 ...
			 public function update($id_produk){
				 ...
				 $this->load->view('admin/updatetablet_v',$data);
				}
